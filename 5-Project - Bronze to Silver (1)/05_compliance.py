...
# TODO
display(spark.sql("""
select version as previous_ver from (DESCRIBE HISTORY health_tracker_classic_silver) order by version desc limit 1 offset 1
"""))
...
# TODO
display(spark.sql("""
select version as current_ver from (DESCRIBE HISTORY health_tracker_classic_silver) order by version desc limit 1
"""))
...
try:
    spark.sql(
        """
    VACUUM health_tracker_classic_silver RETAIN 168 Hours
    """
    )
