...
event_hub_connection_string = "Endpoint=sb://eventhubpleasedelete.servicebus.windows.net/;SharedAccessKeyName=testp6policy;SharedAccessKey=Bn2xHwkIfXXN34NLlAyrx3RHpAF8vDA914xpWqyO8Dc=;EntityPath=testp6" # Paste your Event Hubs connection string in the quotes to the left
